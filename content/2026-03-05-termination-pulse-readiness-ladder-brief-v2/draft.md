...
## What to do now
1. Implement a six-rung readiness ladder across active China termination cases.
2. Assign owner/backups and SLAs for each rung.
3. Enforce strict in-order progression with no shortcuts.
4. Add rollback triggers for newly discovered contradictions.
5. Track stall and rollback metrics weekly.
6. Train managers on communication rung prerequisites.
7. Use rung analytics to strengthen templates and controls.
