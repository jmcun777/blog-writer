...
## What to do now
1. Deploy six control questions across all active China termination cases.
2. Assign owner/backups and SLAs for each question.
3. Enforce no-go on failed route/evidence/payroll/local questions.
4. Add daily question status review to cross-functional standups.
5. Track repeated failed questions by case type.
6. Train managers on communication control requirements.
7. Update question definitions monthly based on outcomes.
