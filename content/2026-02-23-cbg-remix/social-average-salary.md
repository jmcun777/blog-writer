# Social Average Salary in China: Why It Matters for Employer Planning in 2026
...
- The operational priority is **social average salary benchmark interpretation for planning** with clear owner accountability.
- Current risk concentration: **misusing benchmark data as a direct salary-setting proxy**.
...
- separate benchmark analysis from pay-band decisions
- map benchmark impact on cost forecasts
- review assumptions each policy cycle
- brief finance on variance scenarios
