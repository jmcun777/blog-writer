...
html = f'''<!doctype html><html><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>China Payroll Blog</title></head><body style="font-family:Arial,sans-serif;max-width:900px;margin:30px auto;padding:0 16px"><h1>China Payroll Blog</h1><p>Latest posts:</p><ul>{''.join(items)}</ul></body></html>'''
